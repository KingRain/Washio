...
class BookingPageTwoNext extends StatefulWidget {
  const BookingPageTwoNext({super.key});

  @override
  _BookingPageTwoNextState createState() => _BookingPageTwoNextState();
}

class _BookingPageTwoNextState extends State<BookingPageTwoNext> {
  ...
  Future<void> submitData() async {
    ...
    final existingSlots =
        await Supabase.instance.client.from('floor2_nextday').select('Slot');
    /*
