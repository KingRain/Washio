...
class BookingPageZero extends StatefulWidget {
  const BookingPageZero({super.key});

  @override
  _BookingPageZeroState createState() => _BookingPageZeroState();
}

class _BookingPageZeroState extends State<BookingPageZero> {
  ...
  Future<void> submitData() async {
    ...
    final existingSlots =
        await Supabase.instance.client.from('floor0').select('Slot');
    /*
    ...
    */
    ...
    final response = await Supabase.instance.client.from('floor0').insert({
      'Name': "$name ($roomNo)",
      'RoomNo': roomNo,
      'Slot': slot,
      'CurrentDay': "True"
